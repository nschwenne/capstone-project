    ...
    return(
        <div>
            ...
            <div id="armor_class">
                    ...
                    onChange ={(e) => setInfo({
                        ...info, armor_class:(e.target.value)})
                        }/>
                    </div>
                    <br></br>
                    <div id="initiative">
                    ...
                    onChange ={(e) => setInfo({
                        ...info, initiative:(e.target.value)})
                        }/>
                    </div>
                    <br></br>
                    <div id="speed">
                    ...
                    onChange ={(e) => setInfo({
                        ...info, hit_point_maximum:(e.target.value)})
                        }/>
                    </div>
                    <br></br>
                    ...
                    onChange ={(e) => setInfo({
                        ...info, current_hit_points:(e.target.value)})
                        }/>
                    </div>
                    <br></br>
                    ...
                    onChange ={(e) => setInfo({
                        ...info, temporary_hit_points:(e.target.value)})
                        }/>
                    </div>
                    <br></br>
                    <div id="hit_dice">
